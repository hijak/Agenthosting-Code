export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using AgentHosting, you agree to our ",
  ...
  "tui.tips.free_api_sunset":
    "The free API service has ended. Run {highlight}/login{/highlight} to sign in. Subscribe to the AgentHosting Plan or configure a third-party API to use AgentHosting.",
  ...
  "tui.tips.config_files":
    "Create {highlight}agenthosting.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/agenthosting/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "AgentHosting auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.agenthosting/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.agenthosting/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "AgentHosting auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "AgentHosting uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.agenthosting/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.agenthosting/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent AgentHosting from reading sensitive files",
  "tui.tips.run": "Use {highlight}ah run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}ah --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}ah run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}ah serve{/highlight} for headless API access to AgentHosting",
  "tui.tips.attach_server": "Use {highlight}ah run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}ah upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}ah providers list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}ah agent create{/highlight} for guided agent creation",
  "tui.tips.github_install": "Run {highlight}ah github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.agenthosting/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}ah debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with AgentHosting for curated, tested models",
  ...
  "tui.skill.mimocode.description": "Self-documentation for AgentHosting features, config, and commands",
  ...
  "tui.skill.drive-mimo.description": "Programmatically drive another AgentHosting process — headless JSON events or interactive TUI via tmux",
  ...
  "tui.dialog.free_api_sunset.message":
    "Run /login to sign in. Subscribe to the AgentHosting Plan or configure a third-party API to use AgentHosting.",
  ...
  "tui.model.mimo_auto.name": " ( free until Jul 26, 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Ask AgentHosting to delegate the unfinished work to this harness",
  ...
  "tui.toast.update_available.success": "Successfully updated to AgentHosting v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to AgentHosting, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.agenthosting": "AgentHosting",
  "tui.dialog.login.agenthosting.desc": "(Recommended)",
  "tui.dialog.login.mimo_free": "",
  "tui.dialog.login.mimo_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.mimo_free.success": " is ready — default model set to agenthosting/login",
  "tui.dialog.login.mimo_free.unavailable": " provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.mimo.recommended_hint": "recommended",
  "cli.providers.mimo_free.hint": "Anonymous free channel / login",
  "cli.providers.mimo_free.verifying": "Verifying  channel...",
  "cli.providers.mimo_free.ready": " channel ready",
  "cli.providers.mimo_free.failed": " verification failed",
  "cli.providers.mimo_free.default_set": "Default model set to agenthosting/login (1M context, free)",
  "cli.providers.mimo_free.usage_hint": "No login required — just run ah. For paid/premium models, choose AgentHosting browser login instead.",
  ...
  "tui.dialog.login.flow.title": "AgentHosting Login",
  ...
  "trust.capabilities": "AgentHosting will be able to read, edit, and execute files here.",
  ...
  "skip_permissions.body":
    "You started with --dangerously-skip-permissions. AgentHosting will read, edit, and execute files and run shell commands WITHOUT asking for approval. Only rules you have explicitly denied in config are still enforced. You are solely responsible for anything it does.",
