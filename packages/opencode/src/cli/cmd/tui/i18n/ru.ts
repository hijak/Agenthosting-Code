...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Используя AgentHosting, вы соглашаетесь с нашими ",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}agenthosting.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/agenthosting/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "AgentHosting автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.agenthosting/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.custom_agent":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.agenthosting/agent/{/highlight} для специализированных AI-персон",
  ...
  "tui.tips.formatter":
    "AgentHosting автоматически форматирует файлы с помощью prettier, gofmt, ruff и других инструментов",
  ...
  "tui.tips.lsp": "AgentHosting использует LSP-серверы для интеллектуального анализа кода",
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.agenthosting/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.agenthosting/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.agenthosting/themes/{/highlight}",
  ...
  "tui.skill.mimocode.description": "Самодокументация функций, конфигурации и команд AgentHosting",
  ...
  "tui.skill.drive-mimo.description": "Программное управление другим процессом AgentHosting — headless JSON-события или интерактивный TUI через tmux",
  ...
  "tui.toast.update_available.success": "Обновлено до AgentHosting v{{version}}. Пожалуйста, перезапустите приложение.",
