...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 AgentHosting 即表示你同意我们的",
  ...
  "tui.tips.free_api_sunset":
    "免费 API 服务已终止。请使用 {highlight}/login{/highlight} 登录，欢迎订阅AgentHosting Plan或配置第三方 API 后使用 AgentHosting。",
  ...
  "tui.tips.config_files":
    "创建 {highlight}agenthosting.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/agenthosting/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "AgentHosting 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.agenthosting/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.agenthosting/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "AgentHosting 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "AgentHosting 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.agenthosting/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.agenthosting/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 AgentHosting 读取敏感文件",
  "tui.tips.run": "用 {highlight}ah run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}ah --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}ah run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}ah serve{/highlight} 以无头模式提供 AgentHosting API",
  "tui.tips.attach_server": "用 {highlight}ah run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}ah upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}ah providers list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}ah agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_install": "运行 {highlight}ah github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.agenthosting/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}ah debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.zen": "搭配 AgentHosting 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.skill.mimocode.description": "AgentHosting 功能、配置与命令的自文档参考",
  ...
  "tui.skill.drive-mimo.description": "以编程方式驱动另一个 AgentHosting 进程——无头 JSON 事件或通过 tmux 交互",
  ...
  "tui.skill.mimocode.slash": "AgentHosting文档",
  ...
  "tui.skill.drive-mimo.slash": "驱动AgentHosting",
  ...
  "tui.dialog.free_api_sunset.message":
    "请使用 /login 登录，欢迎订阅AgentHosting Plan或配置第三方 API 后使用 AgentHosting。",
  ...
  "tui.model.mimo_auto.name": "（ 限免至 7 月 26 日 18:00 · UTC+8）",
  ...
  "tui.dialog.try_best.handoff.description": "让 AgentHosting 将未完成的工作委派给此 harness",
  ...
  "tui.toast.update_available.success": "已更新到 AgentHosting v{{version}}，请重启应用。",
  ...
  "tui.voice.error.no_auth": "请先用 /connect 连接 AgentHosting 账号，或配置 voice.asr_model 指定其他 provider",
  ...
  "tui.dialog.login.agenthosting.desc": "（推荐）",
  "tui.dialog.login.mimo_free": "",
  "tui.dialog.login.mimo_free.desc": "免费匿名通道，无需登录",
  "tui.dialog.login.mimo_free.success": " 已就绪 - 默认模型设为 agenthosting/login",
  "tui.dialog.login.mimo_free.unavailable": " 通道未加载",
  "cli.providers.select": "选择服务商",
  "cli.providers.other": "其他 Provider",
  "cli.providers.mimo.recommended_hint": "推荐",
  "cli.providers.mimo_free.hint": "免费匿名通道 / login",
  "cli.providers.mimo_free.verifying": "正在验证  通道...",
  "cli.providers.mimo_free.ready": " 通道已就绪",
  "cli.providers.mimo_free.failed": " 自检失败",
  "cli.providers.mimo_free.default_set": "默认模型已切换为 agenthosting/login（1M 上下文，免费）",
  "cli.providers.mimo_free.usage_hint": "无需登录，直接 ah run 即可使用。如需付费/更高级模型，可重新选择 AgentHosting 浏览器登录。",
  ...
  "tui.dialog.login.flow.title": "AgentHosting 登录",
  ...
  "trust.capabilities": "AgentHosting 将能够读取、编辑和执行此目录中的文件。",
  ...
  "skip_permissions.body":
    "你使用 --dangerously-skip-permissions 启动。AgentHosting 将在不征求同意的情况下读取、修改、执行文件并运行 Shell 命令。只有你在配置中明确拒绝（deny）的规则仍然生效。由此产生的一切后果由你自行承担。",
