...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar AgentHosting, aceptas nuestros ",
  ...
  "tui.tips.config_files":
    "Crea {highlight}agenthosting.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/agenthosting/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "AgentHosting gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.agenthosting/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.agenthosting/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "AgentHosting formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "AgentHosting usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.agenthosting/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.agenthosting/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.agenthosting/themes/{/highlight}",
  ...
  "tui.skill.mimocode.description": "Autodocumentación de funciones, configuración y comandos de AgentHosting",
  ...
  "tui.skill.drive-mimo.description": "Controla programáticamente otro proceso AgentHosting — eventos JSON headless o TUI interactiva vía tmux",
  ...
  "tui.toast.update_available.success": "Se actualizó a AgentHosting v{{version}}. Por favor reinicie la aplicación.",
